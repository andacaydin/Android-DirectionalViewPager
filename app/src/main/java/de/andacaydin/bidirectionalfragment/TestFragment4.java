...
public final class TestFragment4 extends BiDirectionalFragment {
    private static final String KEY_CONTENT = "TestFragment:Content";

	public static TestFragment4 newInstance(String content) {
	...
	private String mContent = "FOURTH";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        layout.setBackgroundColor(getResources().getColor(R.color.Peru));
        layout.addView(text);
